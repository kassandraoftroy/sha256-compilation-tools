...
def run_tests():
    tests = [
        test_maj(random(), random(), random()),
        test_ch(random(), random()),
        test_bsig(random()),
        test_lsig(random(),random(),random()),
        test_loop(random(),random(),random()),
        test_loop2(random()),
        test_add(random(),random())
    ]
    if tests == [True, True, True, True, True, True, True]:
        return "PASS"
    else:
        print vals
        return "FAIL"
